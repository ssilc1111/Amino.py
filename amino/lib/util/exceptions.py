...
def CheckException(data):
    ...
    elif api_code == 103 or 104: raise InvalidRequest(data)
    ...
    elif api_code == 500 or 700 or 1600: raise RequestedNoLongerExists(data)
    ...
    elif api_code == 4500 or 4501: raise CannotSendCoins(data)
